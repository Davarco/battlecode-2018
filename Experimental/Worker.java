...
public class Worker {
	...
	private static int[][] earthkarbomap;
	...
	public static void runEarth(Unit unit) {
		// ArrayList<MapLocation> tmp = EarthPathing.path(worker, new
	...
	private static void move() {
		...
		/*
		 * TODO Implement the entire worker move function as a heuristic based on
		 * priority
		 */
