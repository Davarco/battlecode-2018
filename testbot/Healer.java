...
public class Healer {
    ...
    private static boolean heal() {
        ...
        for (int i = 0; i < friendlies.size(); i++) {
           if(friendlies.get(i).unitType().equals(UnitType.Healer)){
        	   check1 = true;
           }
           if(friendlies.get(i).unitType().equals(UnitType.Mage)){
        	   check2 = true;
           }
           if(friendlies.get(i).unitType().equals(UnitType.Ranger)){
        	   check3 = true;
           }
