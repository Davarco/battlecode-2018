...
public class Ranger {
    ...
    private static void moveSmall() {
        ...
        if (Player.focalPoint != null) {
            EarthPathing.move(ranger, Player.focalPoint);
        }
    ...
    private static boolean moveTowardsRocketSmall() {
        ...
        if (idx != -1) {
            ...
            if (map.onMap(tmp)) {
                if (!EarthPathing.move(ranger, tmp)) {
                    EarthPathing.tryMove(ranger, ranger.location().mapLocation().directionTo(tmp));
                }
                return true;
            }
            tmp = new MapLocation(Planet.Earth, initx - 1, inity);
    ...
    private static boolean returnToFactory() {
        ...
        EarthPathing.tryMove(ranger, ranger.location().mapLocation().directionTo(units.get(idx).location().mapLocation()));
        return true;
    }
    ...
    private static void moveMars() {
        ...
        */
        ...
        if (Player.focalPointMars != null) {
            ...
            MarsPathing.move(ranger, Player.focalPointMars);
        }
    ...
    private static boolean bounce() {
        ...
        if (dir != null) {
            if (EarthPathing.tryMove(ranger, dir))
    ...
    private static boolean ditchFactory() {
        ...
        Direction opposite = EarthPathing.opposite(ranger.location().mapLocation().directionTo(units.get(idx).location().mapLocation()));
        EarthPathing.tryMove(ranger, opposite);
        return true;
    }
